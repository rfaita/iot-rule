...
public class LessNumericOperatorTest {

    private Operator<BigDecimal> equalsBigDecimalOperator;

    @BeforeEach
    public void setUp() {
        equalsBigDecimalOperator = new LessNumericOperator();
    }

    @Test
    public void less_with_success() {
    ...
    @Test
    public void less_with_equals_values() {
    ...
    @Test
    public void less_with_null_first_value() {
    ...
    @Test
    public void less_with_null_second_value() {
    ...
    @Test
    public void less_with_nulls_values() {
