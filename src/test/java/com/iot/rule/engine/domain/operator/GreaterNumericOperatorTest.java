...
public class GreaterNumericOperatorTest {

    private Operator<BigDecimal> equalsBigDecimalOperator;

    @BeforeEach
    public void setUp() {
        equalsBigDecimalOperator = new GreaterNumericOperator();
    }

    @Test
    public void greater_with_success() {
    ...
    @Test
    public void greater_with_equals_values() {
    ...
    @Test
    public void greater_with_null_first_value() {
    ...
    @Test
    public void greater_with_null_second_value() {
    ...
    @Test
    public void greater_with_nulls_values() {
