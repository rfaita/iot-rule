...
public class LessEqualsNumericOperatorTest {

    private Operator<BigDecimal> equalsBigDecimalOperator;

    @BeforeEach
    public void setUp() {
        equalsBigDecimalOperator = new LessEqualsNumericOperator();
    }

    @Test
    public void less_equals_with_success() {
    ...
    @Test
    public void less_equals_with_fail() {
    ...
    @Test
    public void less_equals_with_equals_values() {
    ...
    @Test
    public void less_equals_with_null_first_value() {
    ...
    @Test
    public void less_equals_with_null_second_value() {
    ...
    @Test
    public void less_equals_with_nulls_values() {
